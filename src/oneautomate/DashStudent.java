 ...
 * @author jayan
 */
public class DashStudent extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
