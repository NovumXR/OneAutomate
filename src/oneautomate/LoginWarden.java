...
public class LoginWarden extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to OneAutomate (Warden)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            e.printStackTrace();
                        ...
                        new LoginWarden().setVisible(true);
                        setVisible(false);
...
private boolean isValidUser(String user,String password) throws SQLException{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginWarden.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
